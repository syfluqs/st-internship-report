% taken from https://gist.github.com/michaelt/1017790

%!TEX TS-program = xelatex
\documentclass[a4paperpaper,$if(fontsize)$$fontsize$$endif$,twoside]{scrartcl}
...
% \setkomafont{title}{\rmfamily\mdseries\upshape\huge}
